...
export default function UserProfile({
  ...
  return (
    <div className="flex flex-col w-full min-h-screen justify-center items-center bg-linear-to-b from-black to-slate-900">
      ...
      <div className="flex flex-col max-w-md bg-[#171717] p-8 rounded-2xl border border-[#2e2e2e] gap-6 shadow-2xl w-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col w-fit">
            ...
            <p className="text-white ">Username: {data?.username || 'N/A'} </p>
            <p className="text-gray-500 ">Email: {data?.email || 'N/A'}</p>
          </div>
        </div>
        <button
